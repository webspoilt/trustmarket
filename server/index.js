...
const startServer = async () => {
  try {
    console.log('🔧 Starting TrustMarket Server...');
    ...
    server.listen(PORT, () => {
      console.log('🚀 TrustMarket Server Started Successfully!');
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log('🧪 Development mode: Local file uploads enabled');
    ...
    console.log('\n💡 TROUBLESHOOTING:');
    console.log('1. Check if MongoDB is running (local) or Atlas cluster is active');
